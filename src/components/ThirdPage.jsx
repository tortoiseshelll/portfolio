  ...
  return (
    <section className="relative min-h-full md:min-h-screen">
      ...
      <div className="relative lg:mx-40 2xl:mx-80  flex-1 justify-center bg-black/50">
        <div className="relative hidden xl:flex justify-center pt-16 z-20">
          <div className="absolute -left-0 top-40">
            ...
            lg:w-60 xl:w-80 border border-black"
            >
              <img src=".\assets\programming\chattingapp\1.png" alt="" />
            </motion.div>
            <motion.div
              initial={{ rotate: 0 }}
              whileInView={{
            ...
            lg:w-60 xl:w-80 border border-black"
            >
              <img src=".\assets\programming\chattingapp\messages.gif" alt="" />
            </motion.div>
          </div>
        </div>

        <div className="relative flex justify-center left-0 2xl:left-20">
          <div className="relative top-10 border border-black">
            <img src=".\assets\programming\chattingapp\overview.gif" alt="" />
          </div>
        </div>

        <div className="relative lg:flex-1 px-10 lg:px-0">
          <div className="relative flex flex-col justify-center md:w-4/5 mx-auto">
            ...
            <p className="text-md lg:text-lg pt-5 leading-9 lg:leading-10 mb-10">
              ...
              Node.js, Socket.io, TailwindCSS, and DaisyUI. The authentication
              and authorization was dealed with JWT, and Zustand was employed
              for global state management. The app has various functions, like
              updating a profile picture, sending real-time messages and
              pictures utilised by Socket.io.
            </p>
          </div>
        ...
        border-black border "
          ...
          <div className="flex flex-col gap-10">
            <div
              className="relative flex-1 2xl:flex justify-center 
      md:w-4/5 mx-auto gap-10 items-center"
          ...
          rounded-xl"
              ...
              <p className="text-sm lg:w-1/2 mx-auto lg:text-lg pt-5 leading-9 lg:leading-10">
      ...
      md:w-4/5 mx-auto gap-10 items-center"
            >
              <p className="text-sm mx-auto lg:w-1/2 lg:text-lg pb-5 leading-9 lg:leading-10">
                Moreover, there is a function that lets the user to remove
                friend without the other party knowing:
              </p>
              <div className="bg-cover ">
                <img
                  className="border border-black
      ...
      md:w-4/5 mx-auto gap-10 items-center"
          ...
          rounded-xl"
              ...
              <p className="text-sm lg:w-1/2 mx-auto lg:text-lg pt-5 leading-9 lg:leading-10">
                ...
                zoom in or center the picture as they wish.
              </p>
            </div>
      ...
      md:w-4/5 mx-auto gap-10 items-center"
            >
              <p className="text-sm lg:w-1/2 mx-auto lg:text-lg pt-5 leading-9 lg:leading-10">
                Additionally, there are many different themes the users can
                change to match their preferences.
              </p>
              <div className="bg-cover ">
                <img
                  className="border border-black

    ...
    <section className="relative min-h-full md:min-h-screen z-10">
      ...
      >
        <div
         ...
         border-black "
        >
          <img src="portfolio\src\assets\programming/todonotes/todo1.jpg" alt="" />
        </div>
      </div>
      ...
      md:w-4/5 mx-auto top-24"
        >
         ...
         "
          ...
          rounded-xl bg-[url(portfolio/src/assets/programming/todonotes/todo2.jpg)]"
              ></div>
        ...
        <div className="relative mx-5 lg:mx-20 lg:top-28">
         ...
         "
          ...
          rounded-xl bg-[url(portfolio/src/assets/programming/todonotes/todo3.jpg)]"
            ></div>
          ...
          <div className="flex justify-center items-center mt-5 lg:mt-10">
            ...
            <div
              className="w-48 h-60 lg:h-80 lg:w-56 bg-cover border border-black
          rounded-xl bg-[url(portfolio/src/assets/programming/todonotes/todo4.jpg)]"
            ></div>
          </div>
          ...
          <div className="relative flex justify-center items-center mt-5 lg:mt-10">
            <div
              className="w-48 h-60 lg:h-80 lg:w-56 bg-cover border border-black
          rounded-xl bg-[url(portfolio/src/assets/programming/todonotes/todo5.jpg)]"
            ></div>
